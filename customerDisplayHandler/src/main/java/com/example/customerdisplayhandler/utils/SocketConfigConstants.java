...
public class SocketConfigConstants {
    public static final int CONNECTION_REQUEST_TIMEOUT = 20000;
    public static final int DEFAULT_SERVER_PORT = 49200;
    public static final String RESPONSE_COMMAND_HANDSHAKE = "HANDSHAKE";
